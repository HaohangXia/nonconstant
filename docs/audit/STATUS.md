...
配置 `latch.yml` · 边界 `CLAUDE.md` · 修正 `amendments/A001~A009` · 报告 `reports/phase0~8,10~11-*.md`
...
| 项 | 内容 |
|---|---|
| ⛔⛔ **发布阻塞** | 名字在**同领域**已被占(latchagent/latch · runlatch 域名 · PyPI/npm)⇒ `LATCH-name-collision-blocks-release` |
